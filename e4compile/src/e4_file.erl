...
encode_varlength_iolist(flat, L) ->
    L;
encode_varlength_iolist(gzip, L) ->
...
encode_literals(LitTab) ->
    ...
    Enc1 = encode_varlength_iolist(?SECTION_ENCODING, LitTab2),
...
encode_atoms(AtomTab) ->
    ...
    Enc1 = encode_varlength_iolist(?SECTION_ENCODING, AtomTab2),
    iolist_to_binary(Enc1).

encode_code(Code) ->
    Code2 = encode_varlength_iolist(?SECTION_ENCODING, Code),
